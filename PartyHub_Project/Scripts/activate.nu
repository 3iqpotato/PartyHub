...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\KIKO-ASUS\PycharmProjects\Django_ORM_FILES\SoftUni_FinalProject\PartyHub_Project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\KIKO-ASUS\PycharmProjects\Django_ORM_FILES\SoftUni_FinalProject\PartyHub_Project\Scripts\deactivate.nu'
