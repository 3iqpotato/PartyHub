...
urlpatterns = [
    ...
    path('mark_as_arrived/<int:ticket_id>/', views.mark_as_arrived, name='mark_as_arrived'),
    # path('mark_as_not_arrived/<int:pk>/', views.MarkAsNotArrivedView.as_view(), name='mark_as_not_arrived'),
    path('mark_as_not_arrived/<int:ticket_id>/', views.mark_as_not_arrived, name='mark_as_not_arrived'),
]