    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(help_text='Set the date and time for the event.')),
                ...
                ('slug', models.SlugField(blank=True, help_text='URL-friendly identifier based on the title.', unique=True)),
