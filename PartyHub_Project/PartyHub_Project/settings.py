"""
Django settings for PartyHub_Project project.
...
# SECURITY WARNING: keep the secret key used in production secret! #TODO: DELETE
...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    'a4d5-77-70-24-15.ngrok-free.app',
]
...
MIDDLEWARE = [
    ...
    'PartyHub_Project.middlewares.CustomErrorHandlingMiddleware',
]

ROOT_URLCONF = 'PartyHub_Project.urls'
...
WSGI_APPLICATION = 'PartyHub_Project.wsgi.application'
